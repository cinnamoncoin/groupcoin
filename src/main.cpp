...
const int nTotalBlocksEstimate = 20373; // Conservative estimate of total nr of blocks on main chain
const int nInitialBlockThreshold = 20000; // Regard blocks up until N-threshold as "initial download"
...
bool CBlock::AcceptBlock()
{
    ...
    if (!fTestNet)
        if ((nHeight ==      1 && hash != uint256("0x00000000c58f75e0fcc7c0658f55d1bced6db68848a29c5c6b0ecc7d4af2b2e3")) ||
            ...
            (nHeight ==   2500 && hash != uint256("0x0000000004eb4798d63ae39b832097db0a147b2ec9c31c4f808b3cab52b5af4b")) ||
            (nHeight ==   5660 && hash != uint256("0x0000000005651aae932395823f3565493b99f22b054c9c9d5554e97aef04daf0")) ||
            (nHeight ==   9500 && hash != uint256("0x0000000009aa713836ab0c4968c757a5d0782ad849ecb44ef4ce9b0c2ad1f481")) ||
            (nHeight ==  15065 && hash != uint256("0x0000000002baec718b9fe043f9db21a1179cd882dd4c88865cc901cf5cead366")) ||
            (nHeight ==  20373 && hash != uint256("0x8119633acd4860c02c5c1743dd3ec6560725e0a5f7a46bef1be14661ebf0ea2a")) ||
            (nHeight ==  42770 && hash != uint256("0xd841c161ed860510445bd83f5785744e5bbb7b1a01489e4888a31eab0bee0eba")))
    ...
    if (hashBestChain == hash)
        CRITICAL_BLOCK(cs_vNodes)
            BOOST_FOREACH(CNode* pnode, vNodes)
                if (nBestHeight > (pnode->nStartingHeight != -1 ? pnode->nStartingHeight - 2000 : nTotalBlocksEstimate))
